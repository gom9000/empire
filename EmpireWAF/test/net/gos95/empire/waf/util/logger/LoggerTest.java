...
extends TestCase
{
	...
	// logger test-files...
	private static String testPropLogFile = "test/resources/logger/logger-test.properties";
	private static String testLogLogFile = "reports/logger.log";
	...
	{
		super.setUp();
		logger = new Logger(testPropLogFile, testLogLogFile);
	}
