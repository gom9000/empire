...
/**
 * The <code>Resultable</code> interface provides constants to describe
 * boolean rappresentation of the result of a task.
 *
...
{
    /** Constant description of positive result of the task */
    static public final boolean SUCCESS = true;

    /** Constant description of not positive result of the task */
    static public final boolean ERROR = false;
}
