...
import net.gos95.empire.dto.DtoPack;


/**
 * The <code>DaoResult</code> class packs a <code>Dto</code> object,
 * returned from a <code>Dao</code> call, and some other attached
 * informations for its transport between business objects.
 *
 * @author  Alessandro Fraschetti
 * @version 1.0, 07/12/2007
 * @see     net.gos95.empire.dto.DtoPack
 */
...
extends DtoPack
{
    ...
    /**
     * Creates a new empty <code>DaoResult</code>.
     * with the given class-version params.
     * 
     * @param clazz classname
     * @param lversion version
     */
    public DaoResult(Class clazz, long lversion)
    {
    ...
    public DaoResult()
    {
        this(DaoResult.class, serialVersionUID);
    }
}
